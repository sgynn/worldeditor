...
class ObjectSplineEditor : public ObjectGroupEditor {
	...
	void saveGroup(ObjectGroup*, base::XMLElement&) const override;
	void saveTemplate(const ObjectGroupData*, base::XMLElement& out) const override;
	ObjectGroup* loadGroup(ObjectGroupData*, const base::XMLElement&) const override;
	ObjectGroup* createGroup(const ObjectGroupData* data, const vec3& position) const override;
	ObjectGroupData* loadTemplate(const base::XMLElement&) override;
